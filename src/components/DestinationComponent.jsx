...
const DestinationComponent = () => {
  ...
  const content = destination.map((content, index) => {
    return (
      <div
        ...
        } px-6 ss:px-10 md:px-0 
      			text-center flex-col md:text-left`}
      >
        <h1 className="text-white text-[75px] ss:text-[100px] uppercase font-Bellefair">
          {content.name}
        </h1>
        <p className="text-babyBlue font-Barlow text-[14px] ss:text-[20px] md:w-[425px] leading-[24px] ss:leading-[32px]">
          {content.description}
        </p>
        ...
        <div className="flex flex-col gap-6 ss:flex-row md:w-[450px] justify-center ss:gap-16 md:gap-0 md:justify-between ">
          <div className="ss:text-left">
            <h4 className="text-babyBlue font-BarlowCondensed text-[16px] font-bold">
              AVG. DISTANCE
            </h4>
            <h3 className="text-white font-Bellefair text-[28px] md:text-[32px] uppercase">
              {content.distance}
            </h3>
          </div>
          <div className="ss:text-left">
  ...
  return (
    ...
    <section id="destination">
      ...
      <Navbar />
      <div
        className="flex gap-4 ss:gap-6 tracking-[0.25rem] justify-center mt-8 
